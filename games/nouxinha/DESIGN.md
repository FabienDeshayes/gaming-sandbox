...
- The base is where a run ends: walking onto it offers to stop, which banks the expedition and writes the save (§6). Choosing to keep going instead refills water to the ceiling before the expedition continues — the hut's other function until the vault exists (§12).
