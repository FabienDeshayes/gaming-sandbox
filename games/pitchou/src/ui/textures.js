// Bakes the one-bit masks in src/data/sprites.js into white textures.
//
// White, not coloured: everything is drawn tinted (COLORS in src/config.js), so
// one texture set serves the whole palette and a token face costs nothing extra
// to recolour when it lands in the basket.

import { SPRITES } from '../data/sprites.js';
import { SPRITE_PX } from '../config.js';

// Phaser's generator maps each character to a palette entry and treats '.' as
// transparent, which is exactly the mask format.
