...
- **Source layout:**
  ...
  | `src/scenes/` | `TitleScene`, `SlotScene` (the NEW GAME / LOAD GAME picker), `SettingsScene` (the palette grid, the music switch, the move-speed slider, the cheat switch), `ExploreScene` |
